...
//	func GetPostsByTags(PostTagsFromUser []string, db *sql.DB) []pkg.Post {
//		var result []pkg.Post
...
//	}
//
//	func GetAllPosts(db *sql.DB) []pkg.Post {
//		var posts []pkg.Post
...
//	}
//
//	func GetPostBySource(sourceName string, db *sql.DB) []pkg.Post {
//		var posts []pkg.Post
